                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    ...
                                    Oferecemos um curso abrangente para o desenvolvimento de sites responsivos e aplicações web modernas.
                                    </p>
                                </div>
                            ...
                            <div className="flex flex-col justify-between bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <p className="text-md font-medium">
                                    Participe de nosso hackathon e colabore com outros profissionais para desenvolver soluções tecnológicas inovadoras.
                                    </p>
                                </div>
                                <div className="flex justify-center mt-auto">
                                    <HashLink smooth to="/programas_projetos#programas" className="text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 text-lg shadow-xl rounded-xl">
                            ...
                            <div className="flex flex-col justify-between bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    ...
                                    <p className="text-md font-medium">
                                        Promovemos a inclusão digital em comunidades carentes, capacitando-as com habilidades tecnológicas para o futuro.
                                    </p>
                                </div>
                                <div className="flex justify-center mt-auto">
                                    <HashLink smooth to="/programas_projetos#programas" className="text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 text-lg shadow-xl rounded-xl">
